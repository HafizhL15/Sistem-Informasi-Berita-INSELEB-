...
@section('container')
            ...
            <div class="article-content">
                ...
                <article class="mt-0 mb-5 text-responsive text-decoration-none">
                    ...
                    <div class="py-4 load-more-btn-container text-center d-flex justify-content-center">
                        <button class="btn btn-danger load-more-btn">Baca Selengkapnya</button>
                    </div>
    ...
    <!-- Load first few sentences of the article initially -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const paragraphs = document.querySelectorAll('.article-content p');
            const loadMoreBtn = document.querySelector('.load-more-btn');
    
            const paragraphsToShowInitially = 12; // Jumlah paragraf yang ditampilkan awalnya
