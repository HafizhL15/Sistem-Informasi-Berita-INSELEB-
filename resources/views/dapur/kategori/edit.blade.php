...
@section('container')
    ...
    <section class="content">
        ...
        <div class="my-3 mx-3">
            <form method="post" action="/dapur-imajinasi/ruangredaksi/kategori/{{ $kategori->slug }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        name="name" maxlength="30" value="{{ old('name', $kategori->name) }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('description') is-invalid @enderror" id="description"
                        name="description" maxlength="170" value="{{ old('description', $kategori->description) }}">
                    @error('description')
                        <div class="invalid-feedback">
                ...
                <button type="submit" class="btn btn-success my-5">Edit Kategori</button>
            </form>
        </div>
    </section>
    <!-- /.content -->
