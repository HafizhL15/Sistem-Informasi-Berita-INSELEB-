    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                ...
                @endif --}}
                <div class="col-sm-6">
                    <a href="/dapur-imajinasi/ruangredaksi/konsep/create" class="btn btn-primary btn-sm"><i
            ...
            <div class="col-12 mt-1">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mt-2">Konsep Artikel</h3>
                                ...
                                @if ($artikels->count())
                                    @foreach ($artikels as $artikel)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ $artikel->created_at->translatedFormat('l, d M Y - H:i') }} WIB</td>
                                            <td class="text-center">
                                                {{-- <a href="/artikel/rlo-{{ $artikel->id }}/{{ $artikel->slug }}" target="_blank"
                                                class="badge bg-info"><i class="fa-solid fa-eye"></i></a> --}}
                                                <a href="/dapur-imajinasi/ruangredaksi/konsep/{{ $artikel->slug }}"
                                                ...
                                                <form action="/dapur-imajinasi/ruangredaksi/konsep/{{ $artikel->slug }}"
