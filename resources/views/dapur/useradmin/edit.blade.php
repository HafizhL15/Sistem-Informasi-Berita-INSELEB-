...
@section('container')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="text-center">
                    <h4>Edit User : {{ $useradmin->name }}</h4>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="my-3 mx-3">
            <form method="post" action="/dapur-imajinasi/ruangredaksi/useradmin/{{ $useradmin->id }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username"
                        name="username" minlength="5" value="{{ old('username', $useradmin->username) }}">
                    @error('username')
                        <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone"
                        name="phone" minlength="10" maxlength="13" value="{{ old('phone', $useradmin->phone) }}">
                    @error('phone')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                        name="address" value="{{ old('address', $useradmin->address) }}">
                    @error('address')
                        <div class="invalid-feedback">
                            Alamat belum diisi
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="role_id">
                        @foreach ($roles as $userrole)
                            @if (old('role_id', $useradmin->role_id) == $userrole->id)
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" name="oldImage" value="{{ $useradmin->image }}">
                    @if ($useradmin->image)
                        <img src="{{ asset('storage/' . $useradmin->image) }}"
