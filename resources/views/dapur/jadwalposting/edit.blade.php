...
@section('container')
    ...
    <section class="content">
        ...
        <div class="my-3 mx-3">
            <form method="post" action="/dapur-imajinasi/ruangredaksi/jadwalposting/{{ $artikel->slug }}"
                ...
                <div class="mb-3">
                    ...
                    @include('dapur.jadwalposting.tagedit')
                </div>
                <div class="mb-3">
                    <label for="longtail" class="form-label">Longtail Keyword</label>
                    @include('dapur.jadwalposting.longtailedit')
                </div>
