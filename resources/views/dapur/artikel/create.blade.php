...
@section('container')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="text-center">
                    <h4 class="fw-bolder">BUAT ARTIKEL BARU</h4>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="my-3 mx-3">
            <form method="post" action="/dapur-imajinasi/ruangredaksi/artikel" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control @error('published_at') is-invalid @enderror"
                        id="published_at" name="published_at" value="{{ now() }}" step="1" />
                    @error('published_at')
                        <div class="invalid-feedback">
                            Tanggal belum diisi
                        </div>
    ...
    <script>
        ...
        title.addEventListener("keyup", function() {
            fetch("/dapur-imajinasi/ruangredaksi/cekSlug?title=" + title.value)
