...
@section('container')
    ...
    <div class="row my-2 justify-content-between">
        <div class="col-md-8">
            ...
            <div class="col my-3 px-2 text-uppercase" style="background-color: #0057a1; color: white">
                <h3>{{ $judul }}</h3>
            </div>

            @if ($longtails->count())
                <div class="">
                    @foreach ($longtails->take(5) as $artikel)
                ...
                <div class="mb-3">
                    @foreach ($longtails->skip(5)->take(5) as $artikel)
                ...
                <div class="mb-3">
                    @foreach ($longtails->skip(10)->take(5) as $artikel)
                        <div class="col d-flex my-2 border-bottom">
                            @if ($artikel->image)
                                <a href="/artikel/rlo-{{ $artikel->id }}/{{ $artikel->slug }}">
                                    <img src="{{ $artikel->image }}" alt="{{ $artikel->title }}" class="me-2 home-img">
