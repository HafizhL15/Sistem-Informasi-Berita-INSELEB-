...
class DapurKirimanPembacaController extends Controller
{
    /**
    ...
    {
        return view('dapur.kiriman.index', [
            'kirimanpembaca' => ArtikelPembaca::latest()->fastPaginate(10)->withQueryString(),
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(ArtikelPembaca $kirimanpembaca, Website $website)
    {
        return view('dapur.kiriman.show', [
            'kirimanpembaca' => $kirimanpembaca,
            'image' => $kirimanpembaca->image,
            'websites' => Website::latest()->take(1)->get(),
            'website' => $website,
            'name' => $website->first()->name,
            'icon' => $website->first()->icon,
